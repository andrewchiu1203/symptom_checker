...
function error(){
    ...
    'font-size:28px;font-family:system-ui;font-weight:normal;background-color:rgb(178, 255, 213);\
     color:rgb(229, 0, 0);border-radius:15px;padding:25px 30px;min-height:250px;width:500px;'
